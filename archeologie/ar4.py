...
def dijkstra():
	...
	output = [[0.0 for _ in row] for row in nodes]
	heapq.heapify(queue)

	# TODO: mine the ones 5 below, 5 right, 5 left and 5 up when moving
	while queue:
